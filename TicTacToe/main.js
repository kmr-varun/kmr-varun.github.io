...
function updateStatus(message, fcolor) {
  document.getElementById("game_stat").innerHTML = message;
  document.getElementById("game_stat").style.color = fcolor;
  document.getElementById("game_container").classList.add("disabled");
  const element = document.getElementById("game_stat");
...
function checkMove() {
  ...
  if (gameLog == "") {
    ...
    if (splitedTextLength == 10) {
      updateStatus("it's a Draw!!", "#fffffe");
    ...
    movesTypes.forEach((uMoves) => {
      ...
      if (inBox1 == uMoves && inBox2 == uMoves && inBox3 == uMoves) {
        ...
        if (getScorePlayer1 == null && uMoves == "X") {
          ...
          updateStatus("Player 1 Wins!!", "#ff8906");
        ...
        if (getScorePlayer2 == null && uMoves == "O") {
          ...
          updateStatus("Player 2 Wins!!", "#e53170");
        ...
        var winnerCross =
          winnerMoves.at(0) + "-" + winnerMoves.at(1) + "-" + winnerMoves.at(2);
        switch (winnerCross) {
          case "box1-box2-box3":
...
function restartGame() {
  document.getElementById("game_stat").innerHTML = "";
  //document.getElementById("score1").innerHTML = sessionStorage.getItem("score-player1");
  document.getElementById("score1").innerHTML = sessionStorage.getItem(
    "score-player1"
  )
    ? sessionStorage.getItem("score-player1")
    : "0";
  ...
  document.getElementById("score2").innerHTML = sessionStorage.getItem(
    "score-player2"
  )
    ? sessionStorage.getItem("score-player2")
    : "0";
  document.getElementById("game-log").value = "";
  ...
  document.getElementById("game_container").classList.remove("disabled");
}
